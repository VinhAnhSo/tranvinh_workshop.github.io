...
3. [Giai đoạn 1: Chuẩn bị Lambda Artifacts](4.3-Prepare-Lambda/)
4. [Giai đoạn 2: Triển khai hạ tầng AWS](4.4-Deploy-Infrastructure/)
5. [Giai đoạn 3: Triển khai Frontend](4.5-Deploy-Frontend/)
6. [Giai đoạn 4: Cấu hình & Kiểm tra](4.6-Configure-Validate/)
